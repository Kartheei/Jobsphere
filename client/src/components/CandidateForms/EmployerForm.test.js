...
describe("EmployerForm Component", () => {
  ...
  test("renders the component correctly", () => {
    ...
    expect(
      screen.getByAltText(
        "A person collecting information on board which contains details regarding another person."
      )
    ).toBeInTheDocument();
    expect(
      screen.getByAltText(
        "Logo for Job Sphere: A circular emblem with the words 'Job Sphere' in bold, modern font, surrounded by interconnected gears symbolizing career opportunities."
      )
    ).toBeInTheDocument();
